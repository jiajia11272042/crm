...
router.post('/', auth_1.authMiddleware, (0, auth_1.roleMiddleware)('admin', 'operator'), async (req, res) => {
    try {
        const data = req.body;
        if (!data.name) {
            return res.json({
...
router.put('/:id', auth_1.authMiddleware, (0, auth_1.roleMiddleware)('admin', 'operator'), async (req, res) => {
    try {
        const id = parseInt(req.params.id);
        if (isNaN(id)) {
            return res.json({
...
router.delete('/:id', auth_1.authMiddleware, (0, auth_1.roleMiddleware)('admin'), async (req, res) => {
    try {
        const id = parseInt(req.params.id);
        if (isNaN(id)) {
            return res.json({
